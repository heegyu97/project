...
<html>
	...
	<body>
		...
		<div class="row">
			...
			<div class="col-3 text-right">
				<a href="${pageContext.request.contextPath}/space/spaceform">
					<button type="button" class="btn float-right mr-4" style="border: 1px solid; color:black; background:D2B8DE;">
					방만들기</button>
				</a>
			</div>
			</div>
		...
		<div class="container row" style="float: none; text-align: center; margin: auto; padding: 0px;">
			...
			<div class=
				...
				<div class="card-body" style = "height: 350px; 
					...
					<a href = "http://localhost:8081/ictedu/space/spacelist?r_no=${list.r_no}">
						<h1  class="card-title mx-auto" style = "margin-top: 70px; overflow: hidden; width: 90%; height: 50px">${list.r_title}</h1>
					</a>
					
					<p class="card-text fontall"><h3 style="color : lime;">개설일 : ${list.r_sdate}</h3></p>
					<p class="card-text fontall"><h3 style="color : lime;">만료일 : ${list.r_cdate}</h3></p>
