...
<html>
	...
	<!-- main on 화면 소스코드 -->
				...
				<table class="table table-hover">
					...
					<tr>
						<th colspan="2"><h3>관리자 정보등록 등록</h3></th>
					</tr>
					<table class="table table-hover">
						<th >고유키</th>
						<td>
							<input type="text" id="m_con_key" name="m_con_key" maxlength="20" class="form-control" value = "${login_info.m_con_key}" readonly> 
						</td>
					</table>
					<table class="table table-hover">
					<tr>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#ok_btn").click(function() {
					...
					$.post(
							"${pageContext.request.contextPath}/manager/updateid", 
							{	
				...
				$("#delete_btn").click(function() {
					...
					if(result){
					    ...
					    $.get(
								...
								"${pageContext.request.contextPath}/manager/deleteid"
								, {
									m_no : ${login_info.m_no},
