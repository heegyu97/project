	...
	<body>
		<%@ include file="/WEB-INF/views/header.jsp"%>
				...
				<table class="table table-hover">
					...
					<tr>
						<th colspan="2"><h3>고양이 정보 등록</h3></th>
					</tr>
					<tr>
						<th>고양이 연령</th>
						<td>
							<div class="input-group">
								<input type="text" id="mcatage" name="mcatage" maxlength="20" class="form-control" value = "${login_info.m_cat_age}">
							</div>
					...
					<tr>
						...
						<td>
							<div class="btn-group" role="group" aria-label="Basic radio toggle button group">
								<input type="radio" class="btn-check" name="mcatsex" id="mcatsex1" value="true" autocomplete="off" ${login_info.m_neut_yn eq "true"?'checked="checked"':''}> 
								<label class="btn btn-outline-primary rounded-pill find-btn1" for="mcatsex1">수컷</label> 
								<input type="radio" class="btn-check" name="mcatsex" id="mcatsex2" value="false" autocomplete="off" ${login_info.m_neut_yn eq "false"?'checked="checked"':''}>
								<label class="btn btn-outline-primary rounded-pill find-btn2" for="mcatsex2">암컷</label>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="btn-group" role="group" aria-label="Basic radio toggle button group">
								<input type="radio" class="btn-check" name="mneutyn" id="mneutyn1" value="true" autocomplete="off" ${login_info.m_neut_yn eq "true"?'checked="checked"':''}> 
								<label class="btn btn-outline-primary rounded-pill find-btn1" for="mneutyn1">O</label> 
								<input type="radio" class="btn-check" name="mneutyn" id="mneutyn2" value="false" autocomplete="off" ${login_info.m_neut_yn eq "false"?'checked="checked"':''}>
								<label class="btn btn-outline-primary rounded-pill find-btn2" for="mneutyn2">X</label>
							</div>
						</td>
					</tr>
					</table>
							...
							<div class="input-group">
								<div class="input-group-text">
									<input type="checkbox" id="email_agree" name="email_agree"
										class="mr-1" ${login_info.m_sms_agree eq "true"?'checked="checked"':''}> EMAIL 수신을 동의 합니다.
								</div>
							</div>
						</td>
					</tr>
				...
				<div class="clearfix">
					<a href="${pageContext.request.contextPath}/guest/myPage">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#ok_btn").click(function() {
					...
					/* 기능검사 */
					$.post(
							"${pageContext.request.contextPath}/guest/updateid", 
							{	
