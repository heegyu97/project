	...
	<!-- main on 화면 소스코드 -->
				...
				<table class="table table-hover">
					...
					<tr>
						...
						<td align = "center">
							<div class="input-group">
								<input type="text" id="hname" name="hname" maxlength="20" class="form-control" readonly>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td align = "center" >
							<div class="input-group">
								<input type="text" id="htel" name="htel" maxlength="45" class="form-control" readonly>
							</div>
						</td>
					</tr>
				</table>
