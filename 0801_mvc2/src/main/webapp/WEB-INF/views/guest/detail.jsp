				...
				<tr>
					<td class="text-left" width="400px" height="100px">
						<div style=" width: 400px; height: 100px; text-overflow: ellipsis; overflow: hidden">
							<h3><em>상품이름 : ${detail_dto.pro_name}</em></h3>
						</div>
					</td>
					<td class="text-right" colspan="3">
						<div class="price">
							
							<div class="sale_price" style="font-size: 15px"><%-- 판매단가  ${detail_dto.pro_price} --%>
								<del> 
									<fmt:formatNumber value="${10000}" pattern="###,###,###원" /> 
								</del>
							</div>
							<div class="discount_price" style="font-size: 25px"><%-- 할인된 가격  ${detail_dto.pro_price - (detail_dto.pro_price *(detail_dto.pro_sale / 100)} --%>
								<span class="dicount_price_number">
									<fmt:formatNumber value=" ${10000 - (10000 * (10 / 100))}" pattern="###,###,###원" />
								</span>
							</div>
						</div>
						<%-- 할인율 ${detail_dto.pro_sale / 100} --%>
						<h6> <fmt:formatNumber value="${10 /100}" pattern="## % 판매자 할인!"/> </h6>
					</td>
				</tr>
				...
				<tr>	
					<td class="text-left" width="250px" height="10px">
						<div style=" width: 250px; height: 20px; text-overflow: ellipsis; overflow: hidden">
							<h6><em>상품이름 : ${detail_dto.pro_name}ㅇㅇㅇㅇ  6666666ㅇㅇㅇ  6666666ㅇㅇㅇ  66666666666666ㅇㅇㅇ  66666666666666ㅇㅇㅇ  66666666666666ㅇㅇㅇ  66666666666666ㅇㅇㅇ  6666666ㅇㅇㅇㅇ</em></h6>
						</div>
					</td>
					<td>
